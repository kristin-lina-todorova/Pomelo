...
import level_1_finished
import level_2_final_code
import level_4_maze
...
BG_IMAGES = [
    pygame.image.load('level_1_city_ruins_bg.png'),
    pygame.image.load(os.path.join('level2_png', 'level_2_portal_1.png')),
    pygame.image.load('level_4_maze.png'),
]
